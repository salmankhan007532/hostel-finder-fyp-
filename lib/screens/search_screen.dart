...
import 'hostel_rating_screen.dart';

class SearchScreen extends StatefulWidget {
  final List<Hostel> hostels;

  const SearchScreen({Key? key, required this.hostels}) : super(key: key);
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Hostel? searchedHostel;

  Future searchHostel( String hostelName) async {
    searchedHostel = null;
    for( var hostel in widget.hostels){
      print(hostelName);
                  ...
                  children: [
                    ...
                    Padding(
                        ...
                        child: Row(children: [
                          ...
                          Text(searchedHostel!.hostelName,
                              style: const TextStyle(fontWeight: FontWeight.bold))
                        ])),
                    Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 5),
                    ...
                    Padding(
                        ...
                        child: Row(children: [
                          ...
                          Text(searchedHostel!.totalRooms,
                              style: const TextStyle(fontWeight: FontWeight.bold))
                        ])),
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 5),
                        ...
                        children: [
                              ...
                              child: ElevatedButton.icon(
                                onPressed: () {
                                  Navigator.of(context)
                                    ...
                                    return SingleHostelLocationScreen(hostel: searchedHostel!);
                                  }));
                                },
                          ...
                          ElevatedButton.icon(
                            onPressed: () {
                              Navigator.of(context)
                                  .push(MaterialPageRoute(builder: (context) {
                                return HostelRatingScreen(hostel: searchedHostel!);
                              }));
                            },
